# -*- coding: utf-8 -*-
#
# orion.algo.nevergrad documentation build configuration file.
#
...
import orion.algo.nevergrad as algo_plugin
...
project = u'orion.algo.nevergrad'
...
htmlhelp_basename = 'nevergraddoc'
...
latex_documents = [
  (master_doc, 'orion.algo.nevergrad.tex',
   u'Oríon algo nevergrad Documentation',
   u'Epistimio', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'nevergrad',
   u'Oríon algo nevergrad Documentation',
   author, 'nevergrad', algo_plugin.__descr__,
   'Miscellaneous'),
]
