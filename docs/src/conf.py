...
latex_documents = [
    (
        master_doc,
        "orion.algo.nevergrad.tex",
        "Oríon algo nevergrad Documentation",
        "Epistimio",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "projectname", "Oríon algo nevergrad Documentation", [author], 1)
]
